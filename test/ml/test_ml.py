...
class TestML:
    ...
    def test_summarize_networks(self):
        dataframe = ml.summarize_networks([INPUT_DIR+'s1/s1.txt',INPUT_DIR+'s2/s2.txt',INPUT_DIR+'s3/s3.txt',INPUT_DIR+'longName/longName.txt', INPUT_DIR+'longName2/longName2.txt', INPUT_DIR+'empty/empty.txt'])
    ...
    def test_pca(self):
        ...
        ml.pca(dataframe, OUT_DIR+'pca/pca.png', OUT_DIR+'pca/pca-components.txt', OUT_DIR+ 'pca/pca-coordinates.csv')
