...
class PRM(ABC, Generic[T]):
    ...
    @classmethod
    def run_typeless(cls, inputs: dict[str, str | os.PathLike], output_file: str | os.PathLike, args: dict[str, Any], container_settings: ProcessedContainerSettings, timeout: Optional[int]):
        """
        ...
        return cls.run(inputs, output_file, T_parsed, container_settings, timeout)

    @staticmethod
    @abstractmethod
    def run(inputs: dict[str, str | os.PathLike], output_file: str | os.PathLike, args: T, container_settings: ProcessedContainerSettings, timeout: Optional[int]):
        """
        Runs an algorithm.
