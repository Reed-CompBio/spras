...
from spras.dataset import Direction, GraphLoopiness, GraphMultiplicity
...
class MEO(PRM):
    ...
    def generate_inputs(data, filename_map):
        ...
        # Create network file
        edges = data.get_interactome([Direction.MIXED, GraphMultiplicity.SIMPLE, GraphLoopiness.NO_LOOPS]).df
