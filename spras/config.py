...
class Config:
    ...
    def process_config(self, raw_config):
        ...
        # TODO should I keep the kernel parameters as seperate parameters and make a dict in the code itself or store them in a dict to use in gridsearchCV?
        # TODO: should we be using gridsearch?
