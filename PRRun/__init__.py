"""
BEELINE Run (:mod:`PRRun`) module contains the following main class:
- :class:`PRRun.PRRun` and three additional classes used in the definition of PRRun class
- :class:`PRRun.ConfigParser`
- :class:`PRRun.InputSettings`
- :class:`PRRun.OutputSettings`


** copied from Beeline repo 
...
class PRRun(object):
    '''
    The PRRun object is created by parsing a user-provided configuration
