...
SPRAS is a Python package that builds on `Snakemake
<https://snakemake.readthedocs.io>`_ and `Docker
<https://en.wikipedia.org/wiki/Docker_(software)>`_ to provide a
standardized, reproducible, and scalable framework for applying pathway
reconstruction methods (PRMs) to omics data.
